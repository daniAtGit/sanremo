                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('canzoni.index')" :active="request()->routeIs('canzoni.*')" wire:navigate>
                                    <i class="fa fa-guitar"></i> Lista
                                </x-dropdown-link>

                                <x-dropdown-link :href="route('canzoni.create')" :active="request()->routeIs('canzoni.*')" wire:navigate>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('artisti.index')" :active="request()->routeIs('canzoni.*')" wire:navigate>
                                    <i class="fa-solid fa-microphone-lines"></i> Lista
                                </x-dropdown-link>

                                <x-dropdown-link :href="route('artisti.create')" :active="request()->routeIs('canzoni.*')" wire:navigate>
                                    <i class="fa-solid fa-plus-circle"></i> Nuovo
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
