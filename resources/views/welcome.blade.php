                        ...
                        @if (Route::has('login'))
                            <nav class="-mx-3 flex flex-1 justify-end">
                                ...
                                @else
                                    <a
                                        href="{{ route('login') }}"
                                        class="border rounded-md px-3 p-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                    >
                                        Login
                                    </a>
                    ...
                    <main class="mt-6">
                        ...
                        <div class="card mt-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="card p-1 my-1" style="width:150px;">
                                            <a href="https://www.google.com/search?q=scenografia+sanremo+{{$edizione->anno}}&tbm=isch" target="_blank">
                                                <img loading="lazy" src="{{$edizione->getScenografiaFromGoogle('scenografia', $edizione->anno)}}" style="width:150px;">
                                            </a>
                                            <span class="small text-secondary">{{\App\Enums\Luogo::from($edizione->luogo->value)->description() ?? ''}}</span>
                                        </div>
                                    </div>
